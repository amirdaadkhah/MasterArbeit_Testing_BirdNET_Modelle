...
class _RecorderViewState extends State<RecorderView> {
  ...
  IconData _LoadingModelIcon = Icons.model_training;
  ...
  Future<void> _startCapture() async {
    await _plugin.start(listener, onError, sampleRate: 48000, bufferSize: 3000);
  }
  ...
  void listener(dynamic obj) {
    print(obj);
    print("The length of the list is : ${obj.length}");
  }
